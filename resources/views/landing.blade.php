...
<body>
        ...
        <div class="container">
            ...
            <div class="how-grid">
                ...
                <div class="how-card">
                    ...
                    <p style="font-size: 0.85rem; color: var(--text-gray);">Isi form dan upload produkmu ke KoperaSiswa.</p>
                </div>
                <div class="how-card">
    ...
    <main class="container" id="produk">
        <section style="padding: 3rem 0;">
            <div style="text-align: center; margin-bottom: 3rem;">
                <h2 style="font-size: 2.2rem; font-weight: 800;">Produk Terbaru Siswa</h2>
                <div style="width: 50px; height: 4px; background: var(--grad); margin: 15px auto; border-radius: 10px;"></div>
                <p style="color: var(--text-gray);">Menampilkan 6 produk terbaru dari siswa SMK 6 Balikpapan</p>
            </div>
            ...
            <div class="view-all-button">
                <a href="{{ route('products.all') }}" class="btn-view-all">
                    <i class="fas fa-th-large"></i> Lihat Semua Produk
                    <i class="fas fa-arrow-right"></i>
                </a>
                <div class="product-count-info">
                    <i class="fas fa-box"></i> Menampilkan {{ $products->count() }} produk terbaru
                </div>
            </div>
            @endif
        </section>
